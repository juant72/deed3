...
contract RealEstate {
    ...
    event PropertySold(uint256 indexed id, address indexed oldOwner, address newOwner, uint256 price);
    event PropertyReSold(uint256 indexed id, address indexed oldOwner, address newOwner, uint256 price);
    ...
    function ListProperty(address owner, 
        uint256 price, 
        ...
        require(price>0, "Price must be greater than cero.");
    ...
    function updateProperty(address owner, 
        uint256 productId,
        string memory _propertyTiles,
        string memory _category,
        string memory _images,
        string memory _propertyAddress,
        string memory _description
        ...
        property.propertyTitle=_propertyTiles;
        property.category=_category;
        property.images=_images;
        property.propertyAddress=_propertyAddress;
        property.description=_description;
    ...
    function updatePrice(address owner, uint256 productId , uint256 price) external returns(string memory) {
        Property storage property = properties[productId];
        require(owner==property.owner,"You are not the owner");
        property.price=price;
