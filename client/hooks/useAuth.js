  ...
  const authState = useMemo(() => {
    ...
    return {
      ...
      user: {
        ...
        id: address || session?.user?.id || session?.user?.email,
 ...
 */
export const useAuthRequirement = (requirement = 'any') => {
  const auth = useAuth();
 ...
 */
export const useProtectedAuth = (requirement = 'any', redirectTo = '/login') => {
