...
const BlockchainBadges = ({ contractAddress, tokenStandard = 'ERC-1155', compact = false }) => {
...
export const ContractInfo = ({ contractAddress, compact = false }) => {
  const blockchainStatus = useBlockchainStatus(contractAddress);
...
export const VerificationBadge = ({ isVerified = true, size = 'md' }) => {
  const sizeClasses = {
    sm: 'w-4 h-4 text-xs',
    md: 'w-5 h-5 text-sm',
